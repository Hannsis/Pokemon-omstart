...
internal class Logics
{
    ...
    public void Run(Bulbasaur bulbasaur, Charmander charmander, Squirtle squirtle)
    {
        ...
        while (Playing)
        {
            MainMenuChoice(pokemonChoice, bulbasaur, charmander, squirtle);
        }
    }

    private void MainMenuChoice(StarterPokemon pokemonChoice, Bulbasaur bulbasaur, Charmander charmander, Squirtle squirtle)
    {
        MenuAlternatives();
            ...
            case "4":
                {
                    ...
                    pokemonChoice.HP = 45 * pokemonChoice.Level;
